...
class Magenta:  
  ...
  #criação de botões
    self.bt_sortear= Button(self.magenta, bd=0.5, image=self.img_botao_sortear, command= self.realizarsorteio1)
    self.bt_sortear.place(width=64, height=64, x=115, y=108)
    self.bt_sortear= Button(self.magenta, bd=0.5, image=self.img_botao_sortear, command=self.realizarsorteio2)
    self.bt_sortear.place(width=64, height=64, x=235, y=108)
    self.bt_sortear= Button(self.magenta, bd=0.5, image=self.img_botao_sortear, command=self.realizarsorteio3)
    self.bt_sortear.place(width=64, height=64, x=355, y=108)
    self.bt_sortear= Button(self.magenta, bd=0.5, image=self.img_botao_sortear, command=self.realizarsorteio4)
    self.bt_sortear.place(width=64, height=64, x=475, y=108)
    self.bt_sortear= Button(self.magenta, bd=0.5, image=self.img_botao_sortear, command=self.realizarsorteio5)
    self.bt_sortear.place(width=64, height=64, x=595, y=108)
    self.bt_apagar= Button(self.magenta, bd=0.5, image=self.img_botao_apagar, command=self.apagartudo)
    self.bt_apagar.place(width=40, height=40, x=600, y=29)
    self.bt_sair= Button(self.magenta, bd=0.5, image=self.img_botao_sair, command=self.magenta.destroy)
